...
<?php $__env->startSection('content'); ?>
    <div class="container text-white mx-auto p-6">
        ...
        <div class="flex items-bottom mb-12 p-4">
            <div class="max-w-screen-xl flex items-center justify-between mx-auto flex-col lg:flex-row">
                ...
                <div class="w-full lg:w-2/3 mx-auto">
                    <img src="<?php echo e(asset("/images/download.png")); ?>" alt="" class="h-auto w-full lg:w-2/3 mx-auto">
                </div>
            </div>
        </div>
        <div class="mb-12 p-4">
            <div class="grid grid-cols-1 lg:grid-cols-3 gap-4 mx-auto max-w-screen-xl">
                ...
                <div class=" bg-[#FFF7FC] text-black p-4 rounded-lg grid grid-cols-3">
                    <div>
                        <img class="max-w-full" src="<?php echo e(asset('/images/support.png')); ?>" alt="support">
                    </div>
                ...
                <div class="bg-[#FFF7FC] text-black p-4 rounded-lg">
                    ...
                    <ul class="text-sm space-y-2 font-medium">
                        <li class="flex items-center">
                            ...
                            <a href="<?php echo e(route('annonces-legales-constitution-sarl-sarlau-snc-scs-sca')); ?>">Constitution de société SARL, SARLAU, SNC, SCS, SCA</a>
                        </li>
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="humbleicons hi-arrow-right w-5 h-5 mr-2 text-blue-400"><path xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16m0 0l-6 6m6-6l-6-6"/></svg>
                            <a href="<?php echo e(route('annonces-legales-constitution-sas')); ?>">Constitution : Société Anonyme Simplifiée (SAS)</a>
                        </li>
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="humbleicons hi-arrow-right w-5 h-5 mr-2 text-blue-400"><path xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16m0 0l-6 6m6-6l-6-6"/></svg>
                            <a href="<?php echo e(route('annonces-legales-constitution-sa')); ?>">Société Anonyme (SA)</a>
                        </li>
                    </ul>
                </div>
                <div class="bg-[#FFF7FC] text-black p-4 rounded-lg">
                    ...
                    <ul class="text-sm space-y-2 font-medium">
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="humbleicons hi-arrow-right w-5 h-5 mr-2 text-blue-400"><path xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16m0 0l-6 6m6-6l-6-6"/></svg>
                            <a href="<?php echo e(route('annonces-legales-dissolution')); ?>">Dissolution</a>
                        </li>
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="humbleicons hi-arrow-right w-5 h-5 mr-2 text-blue-400"><path xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16m0 0l-6 6m6-6l-6-6"/></svg>
                            <a href="<?php echo e(route('annonces-legales-cloture-de-la-liquidation')); ?>">Clôture de la liquidation</a>
                        </li>
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="humbleicons hi-arrow-right w-5 h-5 mr-2 text-blue-400"><path xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16m0 0l-6 6m6-6l-6-6"/></svg>
                            <a href="<?php echo e(route('annonces-legales-continuite-activite')); ?>">Continuité de l'activité</a>
                        </li>
                    </ul>
                </div>
                <div class="bg-[#FFF7FC] text-black p-4 rounded-lg">
                    ...
                    <ul class="text-sm space-y-2 font-medium">
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="humbleicons hi-arrow-right w-5 h-5 mr-2 text-blue-400"><path xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16m0 0l-6 6m6-6l-6-6"/></svg>
                            <a href="<?php echo e(route('annonces-legales-transfert-de-siege-social')); ?>">Transfert de siège social</a>
                        </li>
                        <li class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="humbleicons hi-arrow-right w-5 h-5 mr-2 text-blue-400"><path xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16m0 0l-6 6m6-6l-6-6"/></svg>
                            <a href="<?php echo e(route('annonces-legales-changement-objet-social')); ?>">Changement d'objet social</a>
                        </li>
                        <li  class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="humbleicons hi-arrow-right w-5 h-5 mr-2 text-blue-400"><path xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16m0 0l-6 6m6-6l-6-6"/></svg>
                            <a href="<?php echo e(route('annonces-legales-changement-denomination')); ?>">Changement de dénomination</a>
                        </li>
                        <li  class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="humbleicons hi-arrow-right w-5 h-5 mr-2 text-blue-400"><path xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16m0 0l-6 6m6-6l-6-6"/></svg>
                            <a href="<?php echo e(route('annonces-legales-transformation-forme-sociale')); ?>">Transformation de la forme sociale</a>
                        </li>
                        <li  class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="humbleicons hi-arrow-right w-5 h-5 mr-2 text-blue-400"><path xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16m0 0l-6 6m6-6l-6-6"/></svg>
                            <a href="<?php echo e(route('annonces-legales-reduction-de-capital')); ?>">Réduction de capital</a>
                        </li>
                        <li  class="flex items-center">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="humbleicons hi-arrow-right w-5 h-5 mr-2 text-blue-400"><path xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16m0 0l-6 6m6-6l-6-6"/></svg>
                            <a href="<?php echo e(route('annonces-legales-augmentation-capital')); ?>">Augmentation de capital</a>
                        </li>
                    </ul>
                </div>
            </div>
        ...
        <?php echo $__env->make('user.components.pricing', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    </div>
...
<?php echo $__env->make('user.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ENSET\s3\stage\projet\prj\LegAnno\resources\views/user/home.blade.php ENDPATH**/ ?>