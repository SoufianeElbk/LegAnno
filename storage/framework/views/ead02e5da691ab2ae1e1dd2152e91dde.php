<footer class="container mx-auto bg-indigo-700 font-medium text-white">
    <div class="mx-auto max-w-screen-xl space-y-8 px-4 py-12 sm:px-6 lg:space-y-8 lg:px-8">
        <div class="grid grid-cols-1 gap-4 md:grid-cols-3 lg:grid-cols-4">
            <div class="lg:col-span-2">
                <div class="text-teal-600r flex justify-center sm:block">
                    <img src="<?php echo e(asset('/images/logo2.png')); ?>" alt="Logo" class="h-8">
                </div>
        ...
        <p class="text-sm text-center font-medium">&copy; <a href="/"> LegAnno</a> <?php echo e(date('Y')); ?>. Tous droits réservés.</p>
    </div>
</footer>
<?php /**PATH D:\ENSET\s3\stage\projet\prj\LegAnno\resources\views/user/components/footer.blade.php ENDPATH**/ ?>