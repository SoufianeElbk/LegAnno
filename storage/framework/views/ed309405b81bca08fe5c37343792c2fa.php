...
<?php $__env->startSection('content'); ?>
    <div class="container text-white mx-auto p-6">
        ...
        <form action="<?php echo e(Route('packs.store')); ?>" method="POST" class="">
         <?php echo csrf_field(); ?>
            <div class="max-w-screen-xl mx-auto container">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    ...
                    <div>
                        <img src="<?php echo e(asset('/images/payment.png')); ?>" alt="" srcset="">
                    </div>
                </div>
            </div>
        </form>
...
<?php echo $__env->make('user.layouts.base', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\ENSET\s3\stage\projet\prj\LegAnno\resources\views/user/packs.blade.php ENDPATH**/ ?>