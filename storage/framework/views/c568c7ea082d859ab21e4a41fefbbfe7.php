    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
        ...
        <div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
            ...
            <nav class="mt-10">
                ...
                <a class="flex items-center px-6 py-2 mt-4 text-gray-100 bg-gray-700 bg-opacity-25" href="<?php echo e(Route('manager.annonces-traitees')); ?>">
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="flex items-center">
                                                    <div class="text-sm leading-5 font-medium text-gray-900"><?php echo e($annonce->id); ?></div>
                                                </div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($annonce->date_creation); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($annonce->date_paiement); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">
                                                    <?php if($annonce->creation_sarl_sarlau_snc_scs_sca): ?>
                                                        <?php echo e($annonce->creation_sarl_sarlau_snc_scs_sca->denomination); ?>

                                                    <?php elseif($annonce->creation_societe_anonyme_simplifiee_sas): ?>
                                                        <?php echo e($annonce->creation_societe_anonyme_simplifiee_sas->denomination); ?>

                                                    <?php elseif($annonce->creation_societe_anonyme_sa): ?>
                                                        <?php echo e($annonce->creation_societe_anonyme_sa->denomination); ?>

                                                    <?php elseif($annonce->dissolution): ?>
                                                        <?php echo e($annonce->dissolution->denomination); ?>

                                                    <?php elseif($annonce->cloture_liquidation): ?>
                                                        <?php echo e($annonce->cloture_liquidation->denomination); ?>

                                                    <?php elseif($annonce->continuite_activite): ?>
                                                        <?php echo e($annonce->continuite_activite->denomination); ?>

                                                    <?php elseif($annonce->transfert_siege_social): ?>
                                                        <?php echo e($annonce->transfert_siege_social->denomination); ?>

                                                    <?php elseif($annonce->changement_objet_social): ?>
                                                        <?php echo e($annonce->changement_objet_social->denomination); ?>

                                                    <?php elseif($annonce->changement_denomination): ?>
                                                        <?php echo e($annonce->changement_denomination->denomination); ?>

                                                    <?php elseif($annonce->transformation_forme_sociale): ?>
                                                        <?php echo e($annonce->transformation_forme_sociale->denomination); ?>

                                                    <?php elseif($annonce->reduction_capital): ?>
                                                        <?php echo e($annonce->reduction_capital->denomination); ?>

                                                    <?php elseif($annonce->augmentation_capital): ?>
                                                        <?php echo e($annonce->augmentation_capital->denomination); ?>
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($annonce->type_annonce); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <span class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full
                                                    <?php if($annonce->statut == 'validée'): ?>
                                                        bg-green-100 text-green-800
                                                    <?php elseif($annonce->statut == 'annulée'): ?>
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                                <a href="<?php echo e(Route('manager.annonce-legale.create', $annonce->id)); ?>" class="text-indigo-600 hover:text-indigo-900 flex flex-col items-center">
...
<?php /**PATH D:\ENSET\s3\stage\projet\prj\LegAnno\resources\views/manager/annonces-traitees.blade.php ENDPATH**/ ?>