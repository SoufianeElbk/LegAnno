    ...
    <div class="mx-auto max-w-screen-xl container">
        ...
        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
            ...
            <div class="bg-[#FFF7FC] rounded-lg shadow-lg p-6 relative overflow-hidden h-full">
                ...
                <div class="mb-4">
                    <h3 class="text-2xl font-semibold text-black border-b-4 border-indigo-400 w-fit"><?php echo e($pack->nom); ?></h3>
                </div>
                <div class="mb-4">
                    <img class="w-1/2 mx-auto" src="<?php echo e(asset('/images/packs/'.$pack->image)); ?>" alt="Pack Silver">
                </div>
                <div class="mb-4">
                    <span class="text-4xl font-bold text-black"><?php echo e($pack->prix); ?></span>
                ...
                <ul class="mb-4 space-y-4 text-black">
                    ...
                    <span><?php echo e($pack->nombre_annonces); ?> Annonces</span>
                    </li>
                    <li class="flex items-center">
                    <svg class="h-6 w-6 text-green-500 mr-2" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                    </svg>
                    <span>Prix unitaire : <?php echo e($pack->prix / $pack->nombre_annonces); ?> DH-TTC</span>
                    </li>
                </ul>
                <a href="<?php echo e(Route('packs.create')); ?>" class="flex justify-center space-x-2 w-full py-3 px-6 text-center rounded-md text-white font-medium bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700">
...
<?php /**PATH D:\ENSET\s3\stage\projet\prj\LegAnno\resources\views/user/components/pricing.blade.php ENDPATH**/ ?>