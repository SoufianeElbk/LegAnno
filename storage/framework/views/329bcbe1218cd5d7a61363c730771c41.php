            ...
            <div class="flex flex-col w-full md:w-1/2 p-4">
                <div class="flex flex-col flex-1 justify-center mb-8">
                    ...
                    <div class="w-full mt-4">
                        <form class="form-horizontal w-3/4 mx-auto" method="POST" action="<?php echo e(route('admin.login.create')); ?>">
                            <?php echo csrf_field(); ?>
...
<?php /**PATH D:\ENSET\s3\stage\projet\prj\LegAnno\resources\views/admin/login.blade.php ENDPATH**/ ?>