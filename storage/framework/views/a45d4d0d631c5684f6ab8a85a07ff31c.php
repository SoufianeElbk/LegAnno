...
unset($__sessionArgs); ?>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 -mx-6">
                            <div class="w-full px-6">
                                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white h-full">
                                    ...
                                    <div class="mx-5">
                                        <h4 class="text-2xl font-semibold text-gray-700"><?php echo e($users->total()); ?></h4>
                    ...
                    <div class="flex justify-end">
                        <a href="<?php echo e(Route('admin.users.create')); ?>" class="flex items-center space-x-2 text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w-fit mt-4" style="background-color: #1D4ED8;">
...
<?php /**PATH D:\ENSET\s3\stage\projet\prj\LegAnno\resources\views/admin/users/index.blade.php ENDPATH**/ ?>