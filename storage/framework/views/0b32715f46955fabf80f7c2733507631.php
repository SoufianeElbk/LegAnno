...
<head>
    ...
    <title>Annonces publiées | Admin Dashboard</title>
...
unset($__sessionArgs); ?>
                    <h3 class="text-gray-700 text-3xl font-medium">Annonces validées</h3>
                            ...
                            <div class="w-full px-6">
                                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white h-full">
                                    ...
                                    <div class="mx-5">
                                        ...
                                        <div class="text-gray-500 text-sm">Annonces publiées</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="flex flex-col mt-4">
                                ...
                                <table class="min-w-full">
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($annonce_validee->user->nom); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($annonce_validee->manager->nom); ?></div>
                                            </td>
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($annonce_validee->date_validation); ?></div>
                                            </td>
                        ...
                        <div class="mt-4 pagination">
                            <?php echo e($annonces_validees->links()); ?>
...
<?php /**PATH D:\ENSET\s3\stage\projet\prj\LegAnno\resources\views/admin/annonces-validees/index.blade.php ENDPATH**/ ?>