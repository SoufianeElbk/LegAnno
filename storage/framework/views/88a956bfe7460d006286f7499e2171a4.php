...
<body class="font-[Poppins]">
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container mx-auto px-6 py-8">
                        ...
                        <div class="grid grid-cols-1 sm:grid-cols-2 xl:grid-cols-3 gap-y-6 -mx-6">
                            ...
                            <div class="w-full px-6">
                                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white h-full">
                                    ...
                                    <div class="mx-5">
                                        <h4 class="text-2xl font-semibold text-gray-700"><?php echo e($users->count()); ?></h4>
                            ...
                            <div class="w-full px-6">
                                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white h-full">
                                    ...
                                    <div class="mx-5">
                                        <h4 class="text-2xl font-semibold text-gray-700"><?php echo e($managers->count()); ?></h4>
                            ...
                            <div class="w-full px-6">
                                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white h-full">
                                    ...
                                    <div class="mx-5">
                                        <h4 class="text-2xl font-semibold text-gray-700"><?php echo e($packs->count()); ?></h4>
                            ...
                            <div class="w-full px-6">
                                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white h-full">
                                    ...
                                    <div class="mx-5">
                                        <h4 class="text-2xl font-semibold text-gray-700"><?php echo e(App\Models\Commande::count()); ?></h4>
                            ...
                            <div class="w-full px-6">
                                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white h-full">
                                    ...
                                    <div class="mx-5">
                                        <h4 class="text-2xl font-semibold text-gray-700"><?php echo e(App\Models\Annonce_legale::count()); ?></h4>
                            ...
                            <div class="w-full px-6">
                                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white h-full">
                                    ...
                                    <div class="mx-5">
                                        <h4 class="text-2xl font-semibold text-gray-700"><?php echo e(App\Models\Annonce_legale::where('statut' , '=', 'validée')->count()); ?></h4>
                            ...
                            <div class="w-full px-6">
                                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white h-full">
                                    ...
                                    <div class="mx-5">
                                        <h4 class="text-2xl font-semibold text-gray-700"><?php echo e(App\Models\Annonce_legale::where('statut' , '=', 'annulée')->count()); ?></h4>
                            ...
                            <div class="w-full px-6">
                                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white h-full">
                                    ...
                                    <div class="mx-5">
                                        <h4 class="text-2xl font-semibold text-gray-700"><?php echo e(App\Models\Annonce_legale::where('statut', '=', 'en attente de validation')->count()); ?></h4>
                    ...
                    <h6 class="text-blue-700 text-sm font-light"><a href="<?php echo e(Route('admin.users.index')); ?>">Voir tout</a></h6>
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="flex items-center">
                                                    <div class="text-sm leading-5 font-medium text-gray-900"><?php echo e($user->id); ?></div>
                                                </div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($user->nom); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($user->email); ?></div>
                                            </td>

                                            

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($user->solde); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($user->created_at); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($user->updated_at); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900 flex items-center justify-end space-x-2">
                                                    <a href="<?php echo e(Route('admin.users.edit',$user)); ?>"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-blue-600 cursor-pointer"><path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" /></svg></a>
                    ...
                    <h6 class="text-blue-700 text-sm font-light"><a href="<?php echo e(Route('admin.managers.index')); ?>">Voir tout</a></h6>
                    <div class="flex flex-col mt-4">
                        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                            <div
                                class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                                <table class="min-w-full">
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="flex items-center">
                                                    <div class="text-sm leading-5 font-medium text-gray-900"><?php echo e($manager->id); ?></div>
                                                </div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($manager->nom); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($manager->email); ?></div>
                                            </td>

                                            

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($manager->created_at); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($manager->updated_at); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900 flex items-center justify-end space-x-2">
                                                    <a href="<?php echo e(Route('admin.managers.edit',$manager)); ?>"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-blue-600 cursor-pointer"><path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" /></svg></a>
                                                    <form action="<?php echo e(route('admin.managers.destroy', $manager)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this manager?');">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('DELETE'); ?>
                                                        <button type="submit" class="border-none bg-none cursor-pointer flex items-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-red-600 cursor-pointer">
                    ...
                    <h6 class="text-blue-700 text-sm font-light"><a href="<?php echo e(Route('admin.packs.index')); ?>">Voir tout</a></h6>
                    <div class="flex flex-col mt-4">
                        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                            <div
                                class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                                <table class="min-w-full">
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        <tr>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="flex items-center">
                                                    <div class="text-sm leading-5 font-medium text-gray-900"><?php echo e($pack->id); ?></div>
                                                </div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="">
                                                    <img src="<?php echo e(asset('/images/packs/'.$pack->image)); ?>" alt="<?php echo e($pack->nom); ?>" class="w-32">
                                                </div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($pack->nom); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($pack->prix); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($pack->nombre_annonces); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($pack->created_at); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($pack->updated_at); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900 flex items-center justify-end space-x-2">
                                                    <a href="<?php echo e(Route('admin.packs.edit',$pack)); ?>"><svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-blue-600 cursor-pointer"><path stroke-linecap="round" stroke-linejoin="round" d="m16.862 4.487 1.687-1.688a1.875 1.875 0 1 1 2.652 2.652L10.582 16.07a4.5 4.5 0 0 1-1.897 1.13L6 18l.8-2.685a4.5 4.5 0 0 1 1.13-1.897l8.932-8.931Zm0 0L19.5 7.125M18 14v4.75A2.25 2.25 0 0 1 15.75 21H5.25A2.25 2.25 0 0 1 3 18.75V8.25A2.25 2.25 0 0 1 5.25 6H10" /></svg></a>
                                                    <form action="<?php echo e(route('admin.packs.destroy', $pack)); ?>" method="POST" onsubmit="return confirm('Are you sure you want to delete this pack?');">
                                                        <?php echo csrf_field(); ?>
                                                        <?php echo method_field('DELETE'); ?>
                                                        <button type="submit" class="border-none bg-none cursor-pointer flex items-center">
                                                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6 text-red-600 cursor-pointer">
                    ...
                    <h6 class="text-blue-700 text-sm font-light"><a href="<?php echo e(Route('admin.commandes.index')); ?>">Voir tout</a></h6>
                    <div class="flex flex-col mt-4">
                        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                            <div
                                class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                    ...
                    <?php if($annonces_en_preparation->count() > 0): ?>                    
                    <h3 class="text-gray-700 text-xl font-medium mt-8">Annonces en préparation</h3>
                    <h6 class="text-blue-700 text-sm font-light"><a href="<?php echo e(Route('admin.annonces-en-preparation.index')); ?>">Voir tout</a></h6>
                    <div class="flex flex-col mt-4">
                        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                            <div
                                class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                    ...
                    <?php if($annonces_en_attente->count() > 0): ?>    
                    <h3 class="text-gray-700 text-xl font-medium mt-8">Annonces en attente</h3>
                    <h6 class="text-blue-700 text-sm font-light"><a href="<?php echo e(Route('admin.annonces-en-attente.index')); ?>">Voir tout</a></h6>
                    <div class="flex flex-col mt-4">
                        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                            <div
                                class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                                <table class="min-w-full">
                                    ...
                                    <tbody class="bg-white">
                                        <?php $__empty_1 = true; $__currentLoopData = $annonces_en_attente; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $annonce_en_attente): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="flex items-center">
                                                    <div class="text-sm leading-5 font-medium text-gray-900"><?php echo e($annonce_en_attente->id); ?></div>
                                                </div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($annonce_en_attente->date_creation); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($annonce_en_attente->date_paiement); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">
                                                    <?php if($annonce_en_attente->creation_sarl_sarlau_snc_scs_sca): ?>
                                                        <?php echo e($annonce_en_attente->creation_sarl_sarlau_snc_scs_sca->denomination); ?>

                                                    <?php elseif($annonce_en_attente->creation_societe_anonyme_simplifiee_sas): ?>
                                                        <?php echo e($annonce_en_attente->creation_societe_anonyme_simplifiee_sas->denomination); ?>

                                                    <?php elseif($annonce_en_attente->creation_societe_anonyme_sa): ?>
                                                        <?php echo e($annonce_en_attente->creation_societe_anonyme_sa->denomination); ?>

                                                    <?php elseif($annonce_en_attente->dissolution): ?>
                                                        <?php echo e($annonce_en_attente->dissolution->denomination); ?>

                                                    <?php elseif($annonce_en_attente->cloture_liquidation): ?>
                                                        <?php echo e($annonce_en_attente->cloture_liquidation->denomination); ?>

                                                    <?php elseif($annonce_en_attente->continuite_activite): ?>
                                                        <?php echo e($annonce_en_attente->continuite_activite->denomination); ?>

                                                    <?php elseif($annonce_en_attente->transfert_siege_social): ?>
                                                        <?php echo e($annonce_en_attente->transfert_siege_social->denomination); ?>

                                                    <?php elseif($annonce_en_attente->changement_objet_social): ?>
                                                        <?php echo e($annonce_en_attente->changement_objet_social->denomination); ?>

                                                    <?php elseif($annonce_en_attente->changement_denomination): ?>
                                                        <?php echo e($annonce_en_attente->changement_denomination->denomination); ?>

                                                    <?php elseif($annonce_en_attente->transformation_forme_sociale): ?>
                                                        <?php echo e($annonce_en_attente->transformation_forme_sociale->denomination); ?>

                                                    <?php elseif($annonce_en_attente->reduction_capital): ?>
                                                        <?php echo e($annonce_en_attente->reduction_capital->denomination); ?>

                                                    <?php elseif($annonce_en_attente->augmentation_capital): ?>
                                                        <?php echo e($annonce_en_attente->augmentation_capital->denomination); ?>
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($annonce_en_attente->type_annonce); ?></div>
                                            </td>

                                            

                                            <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                                <a href="<?php echo e(Route('admin.annonce-legale.index', $annonce_en_attente->id)); ?>" class="text-indigo-600 hover:text-indigo-900 flex flex-col items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"><path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" /></svg>
                                                    <span>Voir</span>
                                                </a>
                                            </td>
                    ...
                    <?php if($annonces_validees->count() > 0): ?>    
                    <h3 class="text-gray-700 text-xl font-medium mt-8">Annonces validées</h3>
                    <h6 class="text-blue-700 text-sm font-light"><a href="<?php echo e(Route('admin.annonces-validees.index')); ?>">Voir tout</a></h6>
                    <div class="flex flex-col mt-4">
                        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                            <div
                                class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                                <table class="min-w-full">
                                    ...
                                    <tbody class="bg-white">
                                        <?php $__empty_1 = true; $__currentLoopData = $annonces_validees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $annonce_validee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="flex items-center">
                                                    <div class="text-sm leading-5 font-medium text-gray-900"><?php echo e($annonce_validee->id); ?></div>
                                                </div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($annonce_validee->date_creation); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($annonce_validee->date_paiement); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">
                                                    <?php if($annonce_validee->creation_sarl_sarlau_snc_scs_sca): ?>
                                                        <?php echo e($annonce_validee->creation_sarl_sarlau_snc_scs_sca->denomination); ?>

                                                    <?php elseif($annonce_validee->creation_societe_anonyme_simplifiee_sas): ?>
                                                        <?php echo e($annonce_validee->creation_societe_anonyme_simplifiee_sas->denomination); ?>

                                                    <?php elseif($annonce_validee->creation_societe_anonyme_sa): ?>
                                                        <?php echo e($annonce_validee->creation_societe_anonyme_sa->denomination); ?>

                                                    <?php elseif($annonce_validee->dissolution): ?>
                                                        <?php echo e($annonce_validee->dissolution->denomination); ?>

                                                    <?php elseif($annonce_validee->cloture_liquidation): ?>
                                                        <?php echo e($annonce_validee->cloture_liquidation->denomination); ?>

                                                    <?php elseif($annonce_validee->continuite_activite): ?>
                                                        <?php echo e($annonce_validee->continuite_activite->denomination); ?>

                                                    <?php elseif($annonce_validee->transfert_siege_social): ?>
                                                        <?php echo e($annonce_validee->transfert_siege_social->denomination); ?>

                                                    <?php elseif($annonce_validee->changement_objet_social): ?>
                                                        <?php echo e($annonce_validee->changement_objet_social->denomination); ?>

                                                    <?php elseif($annonce_validee->changement_denomination): ?>
                                                        <?php echo e($annonce_validee->changement_denomination->denomination); ?>

                                                    <?php elseif($annonce_validee->transformation_forme_sociale): ?>
                                                        <?php echo e($annonce_validee->transformation_forme_sociale->denomination); ?>

                                                    <?php elseif($annonce_validee->reduction_capital): ?>
                                                        <?php echo e($annonce_validee->reduction_capital->denomination); ?>

                                                    <?php elseif($annonce_validee->augmentation_capital): ?>
                                                        <?php echo e($annonce_validee->augmentation_capital->denomination); ?>
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($annonce_validee->type_annonce); ?></div>
                                            </td>



                                            <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                                <a href="<?php echo e(Route('admin.annonce-legale.index', $annonce_validee->id)); ?>" class="text-indigo-600 hover:text-indigo-900 flex flex-col items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"><path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" /></svg>
                                                    <span>Voir</span>
                                                </a>
                                            </td>
                    ...
                    <?php if($annonces_annulees->count() > 0): ?>    
                    <h3 class="text-gray-700 text-xl font-medium mt-8">Annonces annulées</h3>
                    <h6 class="text-blue-700 text-sm font-light"><a href="<?php echo e(Route('admin.annonces-annulees.index')); ?>">Voir tout</a></h6>
                    <div class="flex flex-col mt-4">
                        <div class="-my-2 py-2 overflow-x-auto sm:-mx-6 sm:px-6 lg:-mx-8 lg:px-8">
                            <div
                                class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                                <table class="min-w-full">
                                    ...
                                    <tbody class="bg-white">
                                        <?php $__empty_1 = true; $__currentLoopData = $annonces_annulees; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $annonce_annulee): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                                        <tr>
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="flex items-center">
                                                    <div class="text-sm leading-5 font-medium text-gray-900"><?php echo e($annonce_annulee->id); ?></div>
                                                </div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($annonce_annulee->date_creation); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($annonce_annulee->date_paiement); ?></div>
                                            </td>

                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900">
                                                    <?php if($annonce_annulee->creation_sarl_sarlau_snc_scs_sca): ?>
                                                        <?php echo e($annonce_annulee->creation_sarl_sarlau_snc_scs_sca->denomination); ?>

                                                    <?php elseif($annonce_annulee->creation_societe_anonyme_simplifiee_sas): ?>
                                                        <?php echo e($annonce_annulee->creation_societe_anonyme_simplifiee_sas->denomination); ?>

                                                    <?php elseif($annonce_annulee->creation_societe_anonyme_sa): ?>
                                                        <?php echo e($annonce_annulee->creation_societe_anonyme_sa->denomination); ?>

                                                    <?php elseif($annonce_annulee->dissolution): ?>
                                                        <?php echo e($annonce_annulee->dissolution->denomination); ?>

                                                    <?php elseif($annonce_annulee->cloture_liquidation): ?>
                                                        <?php echo e($annonce_annulee->cloture_liquidation->denomination); ?>

                                                    <?php elseif($annonce_annulee->continuite_activite): ?>
                                                        <?php echo e($annonce_annulee->continuite_activite->denomination); ?>

                                                    <?php elseif($annonce_annulee->transfert_siege_social): ?>
                                                        <?php echo e($annonce_annulee->transfert_siege_social->denomination); ?>

                                                    <?php elseif($annonce_annulee->changement_objet_social): ?>
                                                        <?php echo e($annonce_annulee->changement_objet_social->denomination); ?>

                                                    <?php elseif($annonce_annulee->changement_denomination): ?>
                                                        <?php echo e($annonce_annulee->changement_denomination->denomination); ?>

                                                    <?php elseif($annonce_annulee->transformation_forme_sociale): ?>
                                                        <?php echo e($annonce_annulee->transformation_forme_sociale->denomination); ?>

                                                    <?php elseif($annonce_annulee->reduction_capital): ?>
                                                        <?php echo e($annonce_annulee->reduction_capital->denomination); ?>

                                                    <?php elseif($annonce_annulee->augmentation_capital): ?>
                                                        <?php echo e($annonce_annulee->augmentation_capital->denomination); ?>
                                            ...
                                            <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                                <div class="text-sm leading-5 text-gray-900"><?php echo e($annonce_annulee->type_annonce); ?></div>
                                            </td>



                                            <td class="px-6 py-4 whitespace-no-wrap text-right border-b border-gray-200 text-sm leading-5 font-medium">
                                                <a href="<?php echo e(Route('admin.annonce-legale.index', $annonce_annulee->id)); ?>" class="text-indigo-600 hover:text-indigo-900 flex flex-col items-center">
                                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" class="size-6"><path stroke-linecap="round" stroke-linejoin="round" d="M2.036 12.322a1.012 1.012 0 0 1 0-.639C3.423 7.51 7.36 4.5 12 4.5c4.638 0 8.573 3.007 9.963 7.178.07.207.07.431 0 .639C20.577 16.49 16.64 19.5 12 19.5c-4.638 0-8.573-3.007-9.963-7.178Z" /><path stroke-linecap="round" stroke-linejoin="round" d="M15 12a3 3 0 1 1-6 0 3 3 0 0 1 6 0Z" /></svg>
                                                    <span>Voir</span>
                                                </a>
                                            </td>
    ...
    <script>
        ...
        var myChart = new Chart(ctx, {
            type: 'bar',
            data: {
                labels: <?php echo json_encode($packs_chart->pluck('pack_name')); ?>,
                datasets: [{
                    label: 'Packs achetés',
                    data: <?php echo json_encode($packs_chart->pluck('total_bought')); ?>,
...
<?php /**PATH D:\ENSET\s3\stage\projet\prj\LegAnno\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>