        ...
        <div class="min-h-screen bg-indigo-700 text-gray-900 flex justify-center dark:bg-gray-800 dark:text-white">
            <div class="max-w-screen-xl m-0 sm:m-10 shadow sm:rounded-lg flex justify-center flex-1">
                <div class="lg:w-1/2 xl:w-5/12 p-6 sm:p-12 bg-white rounded-lg dark:bg-gray-700">
                    <div>
                        <a href="<?php echo e(Route('home')); ?>"><img src="<?php echo e(asset('images/logo1.png')); ?>" class="w-2/3 mx-auto" alt="Logo"/> </a>
                    </div>
                    <div class="mt-8 flex flex-col items-center">
                        ...
                        <div class="w-full flex-1 mt-4">
                            <div class="mx-auto max-w-xs dark:text-black">
                                ...
                                <p class="mt-6 text-xs text-gray-600 text-center dark:text-white">Vous disposez déjà d'un compte ? <a href="<?php echo e(route('login')); ?>" class="font-semibold">Se connecter</a></p>
                            </div>
                        </div>
                    </div>
                </div>
                <div class="flex-1 bg- text-center hidden lg:flex">
                    <div class="m-12 xl:m-16 w-full bg-contain bg-center bg-no-repeat"
                        style="background-image: url('<?php echo e(asset("/images/download4.png")); ?>');">
                    </div>
                </div>
            </div>
        </div>
...
<?php /**PATH D:\ENSET\s3\stage\projet\prj\LegAnno\resources\views/register.blade.php ENDPATH**/ ?>