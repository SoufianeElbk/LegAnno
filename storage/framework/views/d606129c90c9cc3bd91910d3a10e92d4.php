    ...
    <div x-data="{ sidebarOpen: false }" class="flex h-screen bg-gray-200">
        ...
        <div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
            ...
            <nav class="mt-10">
                ...
                <a class="flex items-center px-6 py-2 mt-4 text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100" href="<?php echo e(Route('manager.annonces-traitees')); ?>">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 -mx-6">
                            <div class="w-full px-6">
                                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white h-full">
                                    ...
                                    <div class="mx-5">
                                        <h4 class="text-2xl font-semibold text-gray-700"><?php echo e($annonces->total()); ?></h4>
...
<?php /**PATH D:\ENSET\s3\stage\projet\prj\LegAnno\resources\views/manager/annonces-en-attente.blade.php ENDPATH**/ ?>