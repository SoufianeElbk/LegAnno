    ...
    <div class="container mx-auto p-6">
        ...
        <form action="{{route('annonces-legales-changement-objet-social')}}" method="POST">
            ...
            <div class="w-full lg:w-3/4 mx-auto text-sm">
                ...
                <div class="mb-4 grid grid-cols-1  bg-white text-black p-8 rounded-lg border-2 border-black">
                    <h1 class="text-xl font-bold border-b-4 border-black w-fit">Modification apportée à l'objet social</h1>
                    <div>
                        <label class="block my-2" for="">Résumé de la modification</label>
                        <input name="modification_objet_social" type="text" class="bg-indigo-50 border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full px-4 py-2>
                    </div>
                </div>
