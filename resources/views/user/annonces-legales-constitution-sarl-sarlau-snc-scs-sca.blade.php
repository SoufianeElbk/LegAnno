            ...
            <div class="w-full lg:w-3/4 mx-auto text-sm">
                ...
                <div class="mb-4 grid grid-cols-1  bg-white text-black p-8 rounded-lg border-2 border-black" id="associe">
                    ...
                    <div id="associe-sections">
                        <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-8 mb-4 relative associe-section" id="form-associe">
                            <div class="flex items-end my-2 lg:col-span-2">
                            ...
                            <div>
                                ...
                                <select name="associes[0][type_associe]" id="" class="text-black w-full px-5 py-2 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white">
                                    <option value="Personne physique">Personne physique</option>
                                    <option value="Personne morale">Personne morale</option>
                                </select>
                            </div>
                            <div>
                                ...
                                <select name="associes[0][civilite_associe]" id="" class="text-black w-full px-5 py-2 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white">
                                    <option value="">Choisir la civilité</option>
                                    <option value="Monsieur">Monsieur</option>
                                    <option value="Madame">Madame</option>
                                </select>
                            ...
                            <div>
                                ...
                                <input name="associes[0][nom_associe]" type="text" class="text-black w-full px-5 py-2 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white">
                            </div>
                            <div>
                                <label class="block my-2" for="">Adresse</label>
                                <input name="associes[0][adresse_associe]" type="text" class="text-black w-full px-5 py-2 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white">
                            </div>
                            <div>
                                <label class="block my-2" for="">Code postal</label>
                                <input name="associes[0][code_postal_associe]" type="text" class="text-black w-full px-5 py-2 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white">
                            </div>
                            <div>
                                <label class="block my-2" for="">Ville</label>
                                <input name="associes[0][ville_associe]" type="text" class="text-black w-full px-5 py-2 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white">
                            </div>
                            <div>
...
$(document).ready(function() {
    ...
    $('#ajouterAssocie').click(function() {
        let newSectionAssocie = `
            <div class="grid grid-cols-1 lg:grid-cols-2 gap-x-8 my-4 relative associe-section border-t-4 pt-4" id="form-associe">
                <div class="flex items-end my-2 lg:col-span-2">
                ...
                <div>
                    <label class="block my-2" for="">Type</label>
                    <select name="associes[${sectionIndexAssocie}][type_associe]" id="" class="text-black w-full px-5 py-2 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white">
                        <option value="Personne physique">Personne physique</option>
                        <option value="Personne morale">Personne morale</option>
                    </select>
                </div>
                <div>
                    <label class="block my-2" for="">Civilité</label>
                    <select name="associes[${sectionIndexAssocie}][civilite_associe]" id="" class="text-black w-full px-5 py-2 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white">
                        <option value="">Choisir la civilité</option>
                        <option value="Monsieur">Monsieur</option>
                        <option value="Madame">Madame</option>
                    </select>
                ...
                <div>
                    <label class="block my-2" for="">Nom</label>
                    <input name="associes[${sectionIndexAssocie}][nom_associe]" type="text" class="text-black w-full px-5 py-2 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white">
                </div>
                <div>
                    <label class="block my-2" for="">Adresse</label>
                    <input name="associes[${sectionIndexAssocie}][adresse_associe]" type="text" class="text-black w-full px-5 py-2 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white">
                </div>
                <div>
                    <label class="block my-2" for="">Code postal</label>
                    <input name="associes[${sectionIndexAssocie}][code_postal_associe]" type="text" class="text-black w-full px-5 py-2 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white">
                </div>
                <div>
                    <label class="block my-2" for="">Ville</label>
                    <input name="associes[${sectionIndexAssocie}][ville_associe]" type="text" class="text-black w-full px-5 py-2 rounded-lg font-medium bg-gray-100 border border-gray-200 placeholder-gray-500 text-sm focus:outline-none focus:border-gray-400 focus:bg-white">
                </div>
                <div>
                    <label class="block my-2" for="">Participation (PARTS)</label>
