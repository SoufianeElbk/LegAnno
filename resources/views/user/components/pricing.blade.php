<section class="py-12" id="packs">
    ...
    <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
        <div class="bg-[#FFF7FC] rounded-lg shadow-lg p-6 relative overflow-hidden">
            ...
            <ul class="mb-8 space-y-4 text-black">
            ...
            <button class="flex justify-center space-x-2 w-full py-3 px-6 text-center rounded-md text-white font-medium bg-gradient-to-r from-purple-600 to-indigo-600 hover:from-purple-700 hover:to-indigo-700">
