...
<div class="bg-white w-full flex flex-col px-3 md:px-8 lg:px-8 lg:flex-row text-[#161931]">
    <aside class="py-4 lg:w-1/4 lg:border-r border-indigo-200">
        <div class="sticky flex flex-col gap-2 p-2 text-sm top-12">
            ...
            <a href="{{Route('user.profile.edit')}}" class="flex items-center space-x-2 px-3 py-2.5 font-semibold  hover:text-indigo-900 hover:border hover:rounded-full">
    ...
    <main class="w-full py-4 lg:w-3/4">
        ...
        <div class="p-2">
            <div class="w-full px-6 pb-8 sm:rounded-lg">
                <h2 class="text-2xl font-bold sm:text-xl">Packs commandés</h2>

                <div class="grid mx-auto mt-4 overflow-x-auto">
                            ...
                            <table class="min-w-full overflow-hidden">
                                <thead>
                                    <tr>
                                        ...
                                        <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Pack</th>
                                        <th class="px-6 py-3 border-b border-gray-200 bg-gray-50 text-left text-xs leading-4 font-medium text-gray-500 uppercase tracking-wider">Montant</th>
                                ...
                                <tbody class="bg-white">
                                    ...
                                    <tr>
                                        ...
                                        <td class="px-6 py-4 whitespace-no-wrap border-b border-gray-200">
                                            <div class="text-sm leading-5 text-gray-900">{{ \Carbon\Carbon::parse($commande->date_commande)->format('d/m/Y H:i:m') }}</div>
                                        </td>
                                        ...
                                        <a href="{{asset('/commandes/commande_'.$commande->id.'.pdf')}}"><svg class="cursor-pointer" xmlns='http://www.w3.org/2000/svg' width='24' height='24' viewBox='0 0 24 24'><title>Commande {{$commande->id}}</title><g id="document_2_line" fill='none' fill-rule='nonzero'><path d='M24 0v24H0V0h24ZM12.593 23.258l-.011.002-.071.035-.02.004-.014-.004-.071-.035c-.01-.004-.019-.001-.024.005l-.004.01-.017.428.005.02.01.013.104.074.015.004.012-.004.104-.074.012-.016.004-.017-.017-.427c-.002-.01-.009-.017-.017-.018Zm.265-.113-.013.002-.185.093-.01.01-.003.011.018.43.005.012.008.007.201.093c.012.004.023 0 .029-.008l.004-.014-.034-.614c-.003-.012-.01-.02-.02-.022Zm-.715.002a.023.023 0 0 0-.027.006l-.006.014-.034.614c0 .012.007.02.017.024l.015-.002.201-.093.01-.008.004-.011.017-.43-.003-.012-.01-.01-.184-.092Z'/><path fill='#09244BFF' d='M13.586 2A2 2 0 0 1 15 2.586L19.414 7A2 2 0 0 1 20 8.414V20a2 2 0 0 1-2 2H6a2 2 0 0 1-2-2V4a2 2 0 0 1 2-2ZM12 4H6v16h12V10h-4.5A1.5 1.5 0 0 1 12 8.5V4Zm3 10a1 1 0 1 1 0 2H9a1 1 0 1 1 0-2h6Zm-5-4a1 1 0 1 1 0 2H9a1 1 0 1 1 0-2Zm4-5.586V8h3.586L14 4.414Z'/></g></svg></a>
                                        </td>
                                    </tr>
                                    @empty
                                    <tr>
