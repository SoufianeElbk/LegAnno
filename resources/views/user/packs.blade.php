        ...
        <form action="{{Route('packs.store')}}" method="POST" class="">
         @csrf
            <div class="max-w-screen-xl mx-auto container">
                <section class="mb-4 p-4" id="packs">
                    <div class="mx-auto">
                        ...
                        <div class="grid grid-cols-1 gap-8 lg:grid-cols-3">
                            ...
                            <div class="bg-[#FFF7FC] rounded-lg shadow-lg p-6 relative overflow-hidden h-full">
                                ...
                                <div class="mb-4 flex items-center justify-between">
                                    ...
                                    <label for="" class="text-black flex space-x-2 items-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="humbleicons hi-arrow-right text-black w-6 h-6"><path xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16m0 0l-6 6m6-6l-6-6"/></svg> <input class="w-4 h-4 text-blue-600 bg-gray-300 border-gray-900 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" type="radio" name="pack_id" value="1"></label>
                                </div>
                                <div class="mb-4">
                            ...
                            <div class="bg-[#FFF7FC] rounded-lg shadow-lg p-6 relative overflow-hidden h-full">
                                ...
                                <div class="mb-4 flex items-center justify-between">
                                    ...
                                    <label for="" class="text-black flex space-x-2 items-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="humbleicons hi-arrow-right text-black w-6 h-6"><path xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16m0 0l-6 6m6-6l-6-6"/></svg> <input class="w-4 h-4 text-blue-600 bg-gray-300 border-gray-900 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" type="radio" name="pack_id" value="2"></label>
                                </div>
                                <div class="mb-4">
                            ...
                            <div class="bg-[#FFF7FC] rounded-lg shadow-lg p-6 relative overflow-hidden h-full">
                                ...
                                <div class="mb-4 flex items-center justify-between">
                                    ...
                                    <label for="" class="text-black flex space-x-2 items-center"><svg xmlns="http://www.w3.org/2000/svg" fill="none" stroke="currentColor" viewBox="0 0 24 24" class="humbleicons hi-arrow-right text-black w-6 h-6"><path xmlns="http://www.w3.org/2000/svg" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 12h16m0 0l-6 6m6-6l-6-6"/></svg> <input class="w-4 h-4 text-blue-600 bg-gray-300 border-gray-900 focus:ring-blue-500 dark:focus:ring-blue-600 dark:ring-offset-gray-800 focus:ring-2 dark:bg-gray-700 dark:border-gray-600" type="radio" name="pack_id" value="3"></label>
                                </div>
                                <div class="mb-4">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2">
                    <div class="p-4 rounded-2xl text-white">
                        ...
                        <h1 class="text-2xl mb-4 font-semibold">Choisissez un moyen de paiement ci-dessous :</h1>
                            ...
                            <div class="mb-4">
                                ...
                                <button type="submit" class="bg-green-500 p-3 rounded-xl text-md sm:text-lg font-medium text-white w-full mt-4">PROCÉDEZ AU PAIEMENT</button>
                            </div>
                    </div>
                    <div>
