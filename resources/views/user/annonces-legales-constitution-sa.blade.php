...
@section('title', "Constitution : Société Anonyme (SA)")
...
<div class="text-white">
    <div class="container mx-auto p-6">
        <div class="w-full lg:w-3/4 mx-auto mb-8">
            <h1 class="text-3xl font-bold">Annonce légale de création de Société Anonyme (SA)</h1>
            <h3 class="mt-4">Ce modèle d'annonce légale en ligne vous permet de publier une Annonce légale de création de Société Anonyme (SA) dans un journal d'annonces légales habilité.</h3>
        </div>
        <form action="{{route('annonces-legales-constitution-sa')}}" method="POST">
