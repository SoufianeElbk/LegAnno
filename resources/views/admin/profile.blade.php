                ...
                <div class="container mx-auto px-6 py-8">
                    ...
                    <div class="grid grid-cols-1 lg:grid-cols-2 gap-4">
                        <div class="flex flex-col items-center col-span-1 lg:col-span-2 text-center">
                            ...
                            <span class="text-xl font-bold">{{Auth::guard('admin')->user()->nom}}</span>
                        </div>

                        <form action="{{Route('admin.profile.updateInfo')}}" method="POST" class="">
                            @csrf
                            @method('patch')
                                        ...
                                        <div class="items-center mt-8 text-[#202142]">
                                            ...
                                            <div class="mb-2 sm:mb-6">
                                                <label for="email"
                                                    ...
                                                    Nom complet</label>
                                                <input name="nom" type="text" id="nom" value="{{Auth::guard('admin')->user()->nom}}"
                                            ...
                                            <div class="mb-4">
                                                <label for="email"
                                                    class="block mb-2 text-sm font-medium text-indigo-900 dark:text-white">
                                                    Email</label>
                                                <input name="email" type="email" id="email" value="{{Auth::guard('admin')->user()->email}}"
                                                    class="bg-indigo-50 border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 "
