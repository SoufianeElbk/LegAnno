...
<head>
    ...
    <title>Annonce légale n {{$Data['annonce']->id}}</title>
        ...
        <div x-cloak :class="sidebarOpen ? 'translate-x-0 ease-out' : '-translate-x-full ease-in'"
            ...
            <nav class="mt-10">
                ...
                <a class="flex items-center px-6 py-2 mt-4 
                    @if($Data['annonce']->statut == 'validée')
                ...
                <a class="flex items-center px-6 py-2 mt-4 
                    @if($Data['annonce']->statut == 'annulée')
                        text-gray-100 bg-gray-700 bg-opacity-25 
                        @else text-gray-500 hover:bg-gray-700 hover:bg-opacity-25 hover:text-gray-100 
                        @endif"
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container mx-auto px-6 py-8 w-fit">
                    ...
                    <h3 class="text-gray-700 text-3xl font-medium mt-8 mx-auto">Annonce legale n {{$Data['annonce']->id}}</h3>
