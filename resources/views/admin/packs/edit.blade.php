        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-white">
                <div class="container mx-auto px-6 py-8">
                    ...
                    <h3 class="text-gray-700 text-3xl font-medium mt-4 text-center">Modifier le pack {{$pack->id}}</h3>
                            ...
                            <div class="p-2">
                                <div class="w-full pb-8 sm:rounded-lg">
                                    ...
                                    <div class="grid max-w-2xl mt-4 mx-auto">
                                        ...
                                        @endif
                                        <form action="{{Route('admin.packs.update', $pack->id)}}" method="POST" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="items-center mt-8 text-[#202142]">
                                                ...
                                                <div class="mb-2 sm:mb-6">
                                                    <label for="email"
                                                        ...
                                                        Nom</label>
                                                    <input name="nom" type="text" id="nom" value="{{old('nom', $pack->nom)}}"
                                                ...
                                                <div class="mb-4">
                                                    <label for="prix"
                                                        class="block mb-2 text-sm font-medium text-indigo-900 dark:text-white">
                                                        Prix</label>
                                                    <input name="prix" type="number" id="prix"  value="{{old('prix', $pack->prix)}}"
                                                        class="border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 "
                                                ...
                                                <div class="mb-4">
                                                    ...
                                                    <input name="nombre_annonces" type="number" id="nombre_annonces" value="{{old('nombre_annonces', $pack->nombre_annonces)}}"
                                                        class="border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 "
                                                ...
                                                <div class="mb-4">
                                                    <label for="nombre_annonces"
                                                        ...
                                                        <img src="{{asset('/images/packs/'.$pack->image)}}" alt="Logo" class="w-1/3 mx-auto">
                                                </div>

                                                <div class="mb-4">
                                                    <label for="image"
                                                        class="block mb-2 text-sm font-medium text-indigo-900 dark:text-white">
                                                        La nouvelle image du pack (laissez ce champs vide si vous voulez gardez la même image)</label>
