        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container mx-auto px-6 py-8">
                    ...
                    @endsession
                    <h3 class="text-gray-700 text-3xl font-medium">Packs</h3>
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 -mx-6">
                            <div class="w-full px-6">
                                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white h-full">
                                    ...
                                    <div class="mx-5">
                                        <h4 class="text-2xl font-semibold text-gray-700">{{$packs->total()}}</h4>
                    ...
                    <div class="flex justify-end">
                        <a href="{{Route('admin.packs.create')}}" class="flex items-center space-x-2 text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w-fit mt-4" style="background-color: #1D4ED8;">
                            ...
                            <div class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                                <table class="min-w-full">
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="8" class="text-center px-6 py-4 whitespace-nowrap text-sm leading-5 font-medium">Aucun pack disponible</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
    ...
    <div id="modelConfirm" class="fixed hidden z-50 inset-0 bg-gray-900 bg-opacity-60 overflow-y-auto h-full w-full px-4 ">
        <div class="relative top-40 mx-auto shadow-xl rounded-md bg-white max-w-md">
            ...
            <div class="p-6 pt-0 text-center">
                ...
                <h3 class="text-xl font-normal text-gray-500 mt-5 mb-6">Vous êtes sure vous voulez supprimer ce pack ?</h3>
                <form action="{{ route('admin.packs.destroy', $pack) }}" method="POST" class="text-white bg-red-600 hover:bg-red-800 focus:ring-4 focus:ring-red-300 font-medium rounded-lg text-base inline-flex items-center px-3 py-2.5 text-center mr-2">
                    @csrf
                    @method('DELETE')
                    <button onclick="closeModal('modelConfirm')" type="submit">
                        Oui, je suis sure
                    </button>
                </form>
