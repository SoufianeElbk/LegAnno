            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-gray-200">
                <div class="container mx-auto px-6 py-8">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-y-6 -mx-6">
                            <div class="w-full px-6">
                                <div class="flex items-center px-5 py-6 shadow-sm rounded-md bg-white h-full">
                                    ...
                                    <div class="mx-5">
                                        <h4 class="text-2xl font-semibold text-gray-700">{{$users->total()}}</h4>
                    ...
                    <div class="flex justify-end">
                        <a href="{{Route('admin.users.create')}}" class="flex items-center space-x-2 text-white bg-blue-700 hover:bg-blue-800 focus:outline-none focus:ring-4 focus:ring-blue-300 font-medium rounded-full text-sm px-5 py-2.5 text-center me-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 w-fit mt-4" style="background-color: #1D4ED8;">
                            ...
                            <div class="align-middle inline-block min-w-full shadow overflow-hidden sm:rounded-lg border-b border-gray-200">
                                <table class="min-w-full">
                                    ...
                                    <tbody class="bg-white">
                                        ...
                                        @empty
                                        <tr>
                                            <td colspan="6" class="text-center px-6 py-4 whitespace-nowrap text-sm leading-5 font-medium">Aucun user disponible</td>
                                        </tr>
                                        @endforelse
                                    </tbody>
                                </table>
