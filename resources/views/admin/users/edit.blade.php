...
<head>
    ...
    <title>Modifier un utilisateur | Admin Dashboard</title>
        ...
        <div class="flex-1 flex flex-col overflow-hidden">
            ...
            <main class="flex-1 overflow-x-hidden overflow-y-auto bg-white">
                <div class="container mx-auto px-6 py-8">
                    ...
                    <h3 class="text-gray-700 text-3xl font-medium mt-4 text-center">Modifier l'utilisateur {{$user->id}}</h3>
                                            ...
                                            <div class="items-center mt-4 text-[#202142]">
                                                ...
                                                <div class="mb-4">
                                                    <label for="solde"
                                                        class="block mb-2 text-sm font-medium text-indigo-900 dark:text-white">
                                                        Solde</label>
                                                    <input name="solde" type="number" id="solde" value="{{ $user->solde }}"
                                                        class="border border-indigo-300 text-indigo-900 text-sm rounded-lg focus:ring-indigo-500 focus:border-indigo-500 block w-full p-2.5 "
                                                        required>
                                                </div>
