        ...
        <div class="flex h-screen bg-indigo-700">
            <div class="w-full max-w-md m-auto bg-indigo-100 rounded p-5">
                ...
                <form>
                    ...
                    <div>
                        <label class="block mb-2 text-indigo-500" for="password">Mot de passe</label>
                    ...
                    <div>
                        <input
                            class="cursor-pointer w-full bg-indigo-700 hover:bg-pink-600 text-white font-bold py-2 px-4 mb-4 rounded"
                            type="submit" value="Connexion">
                    </div>
                </form>
                @if ($error)
                    <div class="mb-4"> 
                        <p class="text-red-600 font-medium w-fit mx-auto">{{$error}}</p>
                    </div>
                @endif
                <footer>
                    <a class="text-indigo-700 hover:text-pink-700 text-sm float-left" href="#">Mot de passe oublié ?</a>
                    <a class="text-indigo-700 hover:text-pink-700 text-sm float-right" href="#">Creér un Compte</a>
                </footer>
            </div>
        </div>
    </div>
