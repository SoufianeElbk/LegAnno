    ...
    <div class="container mx-auto">
        <div class="flex h-screen bg-indigo-700 dark:bg-gray-900">
            <div class="w-full max-w-md m-auto bg-indigo-100 dark:bg-gray-800 rounded p-5">
                <header>
                    <img class="w-2/3 mx-auto mb-5" src="{{asset('/images/logo1.png')}}" />
                </header>
                <form>
                    <div>
                        <label class="block mb-2 text-indigo-500 dark:text-gray-300" for="username">Email</label>
                        <input
                            class="w-full p-2 mb-6 text-indigo-700 dark:text-gray-300 border-b-2 border-indigo-500 dark:border-gray-600 outline-none focus:bg-gray-300 dark:focus:bg-gray-700"
                    ...
                    <div>
                        ...
                        <div class="mb-6 flex items-center relative">
                            <input
                                class="w-full p-2 text-indigo-700 dark:text-gray-300 border-b-2 border-indigo-500 dark:border-gray-600 outline-none focus:bg-gray-300 dark:focus:bg-gray-700"
                ...
                <button id="toggle-dark-mode" class="mt-4 p-2 bg-gray-800 text-white rounded">Toggle Dark Mode</button>
            </div>
        </div>
    </div>
</body>
